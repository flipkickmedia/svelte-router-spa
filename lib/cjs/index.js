...
function create_if_block_4(ctx) {
	...
	let current;
	const switch_instance_spread_levels = [/*currentRoute*/ ctx[0].testprops];
	...
	return {
		...
		p(ctx, dirty) {
			...
			? get_spread_update(switch_instance_spread_levels, [get_spread_object(/*currentRoute*/ ctx[0].testprops)])
			: {};
	...
	return {
		...
		p(ctx, dirty) {
			...
			? get_spread_update(switch_instance_spread_levels, [
					...
					dirty & /*currentRoute*/ 1 && get_spread_object(/*currentRoute*/ ctx[0].testprops)
				])
			: {};
...
// (6:0) {#if currentRoute && currentRoute.layout}
...
function create_fragment$2(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*currentRoute*/ ctx[0] && /*currentRoute*/ ctx[0].layout) return 0;
		if (/*currentRoute*/ ctx[0] && /*currentRoute*/ ctx[0].component) return 1;
		if (/*currentRoute*/ ctx[0] && /*currentRoute*/ ctx[0].component && /*currentRoute*/ ctx[0].testprops) return 2;
		if (/*currentRoute*/ ctx[0] && /*currentRoute*/ ctx[0].childRoute) return 3;
		if (/*currentRoute*/ ctx[0] && /*currentRoute*/ ctx[0].props) return 4;
		return -1;
	}
