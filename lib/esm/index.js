...
function create_if_block_4(ctx) {
	...
	let current;
	const switch_instance_spread_levels = [/*currentRoute*/ ctx[0].props];
	...
	return {
		...
		p(ctx, dirty) {
			...
			? get_spread_update(switch_instance_spread_levels, [get_spread_object(/*currentRoute*/ ctx[0].props)])
			: {};
	...
	return {
		...
		p(ctx, dirty) {
			...
			? get_spread_update(switch_instance_spread_levels, [
					...
					dirty & /*currentRoute*/ 1 && get_spread_object(/*currentRoute*/ ctx[0].props)
				])
			: {};
...
function create_fragment$2(ctx) {
	...
	function select_block_type(ctx, dirty) {
		...
		if (/*currentRoute*/ ctx[0] && /*currentRoute*/ ctx[0].component && /*currentRoute*/ ctx[0].props) return 2;
